...
/* harmony import */ var _class_job_listing_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(90);
...
var editJobListingBlock = function editJobListingBlock(props) {
   ...
   * Set our job id.
   */
  var onChangeJob = function onChangeJob(job_id) {
  ...
  return wp.element.createElement(_class_job_listing_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
...
// Register our block.
var jobListingBlock = registerBlockType(lpf_job_listing_data.block_name, settings);
...
var JobListing = function (_Component) {
  ...
  function JobListing(props) {
    ...
    _this.state = {
      jobs: {},
      job: _this.props.job || {},
      jobID: _this.props.jobID ? _this.props.jobID : 0,
      jobsLoaded: false
    };

    _this.jobsEndpoint = 'wp/v2/' + lpf_job_listing_data.jobs_slug;

    // Required for the onClick/onChange/etc. functions to have access to `this`.
    _this.getJob = _this.getJob.bind(_this);
    return _this;
  }
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(JobListing, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.state.jobID && babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.job).length === 0) {
        wp.apiFetch({ path: this.jobsEndpoint + '/' + this.state.jobID }).then(function (job) {
          _this2.setState({ job: job });
        });
      }

      // Fetch all jobs.
      wp.apiFetch({ path: this.jobsEndpoint }).then(function (jobs) {
        _this2.setState({ jobs: _this2.convertJobs(jobs), jobsLoaded: true });
      });
    }
    ...
    key: 'convertJobs',
    value: function convertJobs(jobs) {
      var jobsObject = {};
      for (var ii in jobs) {
    ...
    value: function getJob() {
      var job = typeof event.target.value === 'undefined' || typeof this.state.jobs[event.target.value] === 'undefined' ? {} : this.state.jobs[event.target.value];
    ...
    value: function inspectorControls() {
      ...
      var jobsDropdown = wp.element.createElement(
        PanelRow,
        null,
      ...
      var editJob = this.state.job ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(
          'a',
          { href: this.getEditJobURL() },
          __('Edit Job', 'yikes-level-playing-field')
        )
      ) : '';

      var showTitle = this.state.job ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(
          'label',
        ...
        wp.element.createElement(FormToggle, {
          ...
          onChange: function onChange(e) {
            return _this3.props.toggleFormControl(e, 'show_title');
          }
        })
      ) : '';

      var showDescription = this.state.job ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(
          'label',
        ...
        wp.element.createElement(FormToggle, {
          ...
          onChange: function onChange(e) {
            return _this3.props.toggleFormControl(e, 'show_description');
          }
        })
      ) : '';

      var showJobType = this.state.job ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(
          'label',
        ...
        wp.element.createElement(FormToggle, {
          ...
          onChange: function onChange(e) {
            return _this3.props.toggleFormControl(e, 'show_job_type');
          }
        })
      ) : '';

      var showLocation = this.state.job ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(
          'label',
        ...
        wp.element.createElement(FormToggle, {
          ...
          onChange: function onChange(e) {
            return _this3.props.toggleFormControl(e, 'show_location');
          }
        })
      ) : '';

      var showApplicationButton = this.state.job ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(
          'label',
        ...
        wp.element.createElement(FormToggle, {
          ...
          onChange: function onChange(e) {
            return _this3.props.toggleFormControl(e, 'show_application_button');
          }
        })
      ) : '';

      var editDescriptionText = this.props.showDescription ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(TextControl, {
          ...
          onChange: function onChange(val) {
            return _this3.props.handleValueControl(val, 'description_text');
          }
        })
      ) : '';

      var editDetailsText = this.props.showJobType || this.props.showLocation ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(TextControl, {
          ...
          onChange: function onChange(val) {
            return _this3.props.handleValueControl(val, 'details_text');
          }
        })
      ) : '';

      var editJobTypeText = this.props.showJobType ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(TextControl, {
          ...
          onChange: function onChange(val) {
            return _this3.props.handleValueControl(val, 'job_type_text');
          }
        })
      ) : '';

      var editLocationText = this.props.showLocation ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(TextControl, {
          ...
          onChange: function onChange(val) {
            return _this3.props.handleValueControl(val, 'location_text');
          }
        })
      ) : '';

      var editRemoteLocationText = this.props.showLocation && this.state.job.location === 'remote' ? wp.element.createElement(
        PanelRow,
        null,
        wp.element.createElement(TextControl, {
          id: 'lpf-location-text-control',
          ...
          onChange: function onChange(val) {
            return _this3.props.handleValueControl(val, 'remote_location_text');
          }
        })
      ) : '';
      ...
      var editButtonText = this.props.showApplicationButton ? wp.element.createElement(
        ...
        wp.element.createElement(TextControl, {
          ...
          onChange: function onChange(val) {
            return _this3.props.handleValueControl(val, 'button_text');
          }
        })
      ) : '';
    ...
    key: 'jobsDropdown',
    value: function jobsDropdown() {
      return babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.jobs).length > 0 ? wp.element.createElement(SelectControl, {
    ...
    key: 'jobsDropdownOptions',
    value: function jobsDropdownOptions() {
      var _this4 = this;

      var dropdownOptions = babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.jobs).map(function (job_id) {
        return { value: job_id, label: _this4.state.jobs[job_id].title.rendered };
      });
    ...
    key: 'jobListingTitle',
    value: function jobListingTitle() {
      return wp.element.createElement(
        'h3',
        { className: 'lpf-job-listing-title' },
        this.state.job.title.rendered
      );
    }
    ...
    key: 'jobDescription',
    value: function jobDescription() {
      return wp.element.createElement(
        'div',
        { className: 'lpf-job-listing-description-container' },
        wp.element.createElement(
          'h4',
          { key: 'lpf-job-listing-description-header', className: 'lpf-job-listing-description-header' },
          this.props.descriptionText
        ),
        wp.element.createElement(
          RawHTML,
          { className: 'lpf-job-listing-description' },
          this.state.job.content.rendered
        )
      );
    }
    ...
    key: 'jobListingMeta',
    value: function jobListingMeta() {
      return wp.element.createElement(
        'div',
        { className: 'lpf-job-listing-meta-container' },
    ...
    value: function jobAddress() {
      return wp.element.createElement(
        ...
        wp.element.createElement(
          ...
          this.state.job.address['address-1']
        ),
        wp.element.createElement(
          'div',
          { className: 'lpf-address2' },
          this.state.job.address['address-2']
        ),
        wp.element.createElement(
          'span',
          { className: 'lpf-city' },
          this.state.job.address['city']
        ),
        '\xA0',
        wp.element.createElement(
          'span',
          { className: 'lpf-state' },
          this.state.job.address['state']
        ),
        (this.state.job.address['state'] || this.state.job.address['city']) && (this.state.job.address['zip'] || this.state.job.address['country']) ? wp.element.createElement(
          'span',
        ...
        wp.element.createElement(
          ...
          this.state.job.address['country']
        ),
        wp.element.createElement(
          'div',
          { className: 'lpf-zip' },
          this.state.job.address['zip']
        )
      );
    }
    ...
    value: function jobListingAppButton() {
      return wp.element.createElement(
        'div',
        { className: 'lpf-job-listing-button-container' },
        wp.element.createElement(
          'a',
          { href: '' },
          wp.element.createElement(
            'button',
            { type: 'button', className: 'lpf-job-listing-button' },
...
// module
exports.push([module.i, "/** Need to Import our front-end Application Styles File **/\n/** Also maybe need to not import our front-end application styles file based on the value of our option **/\n", ""]);
